...
def test_setup(request):
    ...
    features = {
        "friends": parsing_ops.SparseFeature(
            index_key="id", value_key="salary", dtype=tf_types.float32, size=4000
        )
    }
...
@pytest.mark.benchmark(group="reads_16_calls_8_pcalls_16_mbatch_1",)
@pytest.mark.parametrize(
    "batch_size,block_length", [(8192, 16), (8192, 64), (8192 * 4, 16), (8192 * 4, 16)]
)
