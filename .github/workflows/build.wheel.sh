...
run_test() {
  ...
  $entry -m pip install -q pytest pytest-benchmark boto3 docker python-dateutil==2.8.0 google-cloud-pubsub==0.39.1 pyarrow==0.16.0 pandas==0.24.2 scikit-learn==0.20.4 google-cloud-bigquery-storage==0.7.0 google-cloud-bigquery==1.22.0 fastavro avro-python3 scikit-image
