...
class AudioGraphIOTensor:
    ...
    # Constructor (private)
    # =============================================================================
    def __init__(self, resource, shape, dtype, rate, internal=False):
    ...
    def __repr__(self):
        meta = "".join(
            [
                ...
                if isinstance(v, io_tensor_ops._IOTensorMeta)
            ]
  ...
  """
    ...
    def __init__(self, filename, internal=False):
        with tf.name_scope("FromAudio"):
            ...
            super().__init__(resource, shape, dtype, rate, internal=internal)
