...
class _IOTensor:
    ...
    def __repr__(self):
        ...
        return "<%s: spec=%s%s>" % (self.__class__.__name__, self.spec, meta)
...
class BaseIOTensor(_IOTensor):
  ...
  """
    ...
    def __init__(self, spec, function, internal=False):
        ...
        self._function = function
        super(BaseIOTensor, self).__init__(spec, internal=internal)
...
class ScalarIOTensor(BaseIOTensor):
  ...
  """
    ...
    def __init__(self, spec, tensor, internal=False):
        ...
        self._tensor = tensor
        super(ScalarIOTensor, self).__init__(spec, None, internal=internal)
...
class _TableIOTensor(_IOTensor):
    ...
    def __init__(self, spec, columns, values, internal=False):
        ...
        self._values = values
        super(_TableIOTensor, self).__init__(spec, internal=internal)
...
class _CollectionIOTensor(_IOTensor):
  ...
  """
    ...
    def __init__(self, spec, keys, values, internal=False):
        self._keys = keys
        self._values = values
        super(_CollectionIOTensor, self).__init__(spec, internal=internal)
...
class _SeriesIOTensor(_IOTensor):
    ...
    def __init__(self, spec, index, value, internal=False):
        self._index = index
        self._value = value
        super(_SeriesIOTensor, self).__init__(spec, internal=internal)
...
class _KeyValueIOTensor(_IOTensor):
    ...
    def __init__(self, spec, function, iterable_init, iterable_next, internal=False):
        ...
        super(_KeyValueIOTensor, self).__init__(spec, internal=internal)
