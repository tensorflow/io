...
// Copied from
// https://github.com/tensorflow/tensorflow/blob/v2.0.0/tensorflow/core/kernels/data/parallel_map_dataset_op.h
// with the following adjustments
// - removed op definition  ParallelMapDatasetOp
// - removed captured function header
// Reason:
// Note, that headers from core/kernels are not public in the TF build
