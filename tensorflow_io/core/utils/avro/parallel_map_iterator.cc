...
// Copied from
// https://github.com/tensorflow/tensorflow/blob/v2.1.0/tensorflow/core/kernels/data/parallel_map_dataset_op.cc
// with the following adjustments
// - removed ParallelMapDatasetOp because we don't need it
// - added stats_utils with own namespace -- since this part of TF is not public
...
string ThreadUtilizationScalarName(const string& prefix) {
  return strings::StrCat(prefix, "::", "execution_time");
}
