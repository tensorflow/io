#ifndef TENSORFLOW_IO_GSTPUFS_GCE_MEMCACHED_SERVER_LIST_PROVIDER_H_  // NOLINT
#define TENSORFLOW_IO_GSTPUFS_GCE_MEMCACHED_SERVER_LIST_PROVIDER_H_  // NOLINT
...
#endif  // TENSORFLOW_IO_GSTPUFS_GCE_MEMCACHED_SERVER_LIST_PROVIDER_H_
