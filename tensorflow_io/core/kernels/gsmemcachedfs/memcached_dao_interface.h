#ifndef TENSORFLOW_IO_GSMEMCACHEDFS_MEMCACHED_DAO_INTERFACE_H_
#define TENSORFLOW_IO_GSMEMCACHEDFS_MEMCACHED_DAO_INTERFACE_H_
...
#endif  // TENSORFLOW_IO_GSMEMCACHEDFS_MEMCACHED_DAO_INTERFACE_H_
