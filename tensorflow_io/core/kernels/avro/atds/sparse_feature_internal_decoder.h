#ifndef TENSORFLOW_DATA_CORE_KERNELS_AVRO_ATDS_SPARSE_FEATURE_INTERNAL_DECODER_H_
#define TENSORFLOW_DATA_CORE_KERNELS_AVRO_ATDS_SPARSE_FEATURE_INTERNAL_DECODER_H_
...
#endif // TENSORFLOW_DATA_CORE_KERNELS_AVRO_ATDS_SPARSE_FEATURE_INTERNAL_DECODER_H_
