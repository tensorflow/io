...
void VarlenDecoderTest(const T& values, DataType dtype,
                       ...
                       const std::vector<Type>& expected_values,
                       long offset, const avro::Type avro_type = avro::AVRO_NULL) {
  ...
  ValidateBuffer(buffer, varlen_features[0], expected_indices,
                 expected_values, expected_num_elements);
}
...
TEST(VarlenDecoderTest, DT_INT32_1D) {
  ...
  VarlenDecoderTest(values, DT_INT32, {-1}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_INT64_scalar) {
  ...
  VarlenDecoderTest(value, DT_INT64, {}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_INT64_1D) {
  ...
  VarlenDecoderTest(values, DT_INT64, {-1}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_FLOAT_scalar) {
  ...
  VarlenDecoderTest(value, DT_FLOAT, {}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_FLOAT_1D) {
  ...
  VarlenDecoderTest(values, DT_FLOAT, {-1}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_DOUBLE_scalar) {
  ...
  VarlenDecoderTest(value, DT_DOUBLE, {}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_DOUBLE_1D) {
  ...
  VarlenDecoderTest(values, DT_DOUBLE, {-1}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_STRING_scalar) {
  ...
  VarlenDecoderTest(value, DT_STRING, {}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_STRING_1D) {
  ...
  VarlenDecoderTest(values, DT_STRING, {-1}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_BOOL_scalar) {
  ...
  VarlenDecoderTest(value, DT_BOOL, {}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_BOOL_1D) {
  ...
  VarlenDecoderTest(values, DT_BOOL, {-1}, expected_indices,
                    expected_values, offset);
}
...
TEST(VarlenDecoderTest, DT_BOOL_2D) {
  ...
  VarlenDecoderTest(values, DT_BOOL, {2, -1}, expected_indices,
                    expected_values, offset);
}
