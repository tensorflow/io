...
def _impl(ctx):
    tool_paths = [
        ...
        tool_path(name = "cpp", path = "/usr/lib/llvm-16/bin/clang-cpp"),
        tool_path(name = "gcc", path = "/usr/lib/llvm-16/bin/clang"),
        tool_path(name = "dwp", path = "/usr/bin/dwp"),
        tool_path(name = "gcov", path = "/usr/lib/llvm-16/bin/llvm-cov"),
        tool_path(name = "nm", path = "/usr/lib/llvm-16/bin/clang-nm"),
    ...
    cxx_builtin_include_directories = [
        ...
        "/dt10/usr/include/aarch64-linux-gnu",
        "/dt10/usr/include",
        "/dt10/usr/include/c++/10",
        "/dt10/usr/include/c++/10/aarch64-unknown-linux-gnu",
        "/dt10/usr/include/c++/10/backward",
    ]
    ...
    return cc_common.create_cc_toolchain_config_info(
        ...
        toolchain_identifier = "linux_clang_aarch64",
